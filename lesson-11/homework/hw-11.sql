...
--EASY--
	...
	select c.FirstName,c.LastName,count(o.OrderID) as TotalOrders from Orders as o
	join Customers as c on o.CustomerID=c.CustomerID
...
--MEDIUM--
	...
	select c.FirstName,c.LastName,sum(o.TotalAmount) as TotalOrder from Orders as o
	join Customers as c on o.CustomerID=c.CustomerID
	group by c.FirstName,c.LastName
	...
	where d.DepartmentName = 'HR' and e.Salary >60000
														---resultda departmentnameda hr umumam yoq, tableni ozida ham
...
--HARD--
	...
	join Orders as o on c.CustomerID=o.CustomerID
	where c.City= 'USA' and c.Address like '[0-9][0-9][0-9][0-9]%'
