...
--?? Expected Columns: EmployeeName, ManagerName
	...
	join Employees as b on a.ManagerID=b.EmployeeID
...
--?? Expected Columns: Employee1, Employee2, ManagerID
	...
	select a.Name as Employee1,b.Name as Employee2,a.ManagerID from Employees as a
	join Employees as b on a.ManagerID=b.ManagerID and a.EmployeeID<b.EmployeeID
...
) avg_dept ON e.DepartmentID = avg_dept.DepartmentID
...
--?? Expected Columns: OrderID, OrderDate
	...
	where o.OrderDate < '2020-01-01' or p.OrderID is null
...
--?? Expected Columns: Employee1, Employee2, ManagerID, Salary
	...
	select a.Name,b.Name,a.ManagerID,a.Salary,b.Salary from Employees as a
	join Employees as b on a.ManagerID=b.ManagerID and a.EmployeeID<b.EmployeeID	
...
--?? Expected Columns: StudentID, StudentName
	...
	select s.StudentID,s.Name,CourseName from Students as s
	join Enrollments as e on s.StudentID=e.StudentID
